...
export default function Home() {
  ...
  return (
    <>
      ...
      <a className="whatsapp-float" href="https://api.whatsapp.com/send/?phone=5595991505132" target="_blank" rel="noreferrer" aria-label="Falar com a Dr. Sorriso no WhatsApp">WA</a>
    </>
  );
}
